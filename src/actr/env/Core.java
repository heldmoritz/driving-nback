...
public class Core {
	...
	public Core() // default: Core() without public. I changed this to get access to the filename
					// - mlh
	{
	...
	/**
	 * Opens the given file. If the current frame has an unchanged blank document,
	 * the file is loaded into the current frame; otherwise, the file is loaded into
	 * a new frame.
	 * 
	 * @param file the file
	 */
	...
	/**
	 * Closes all frames, except when a frame is unsaved and the user cancels the
	 * save operation.
	 * 
	 * @return <tt>true</tt> if all frames were closed, or <tt>false</tt> otherwise
	 */
	...
	/**
	 * Closes all frames and exits the application, except when a frame is unsaved
	 * and the user cancels the save operation.
	 * 
	 * @return <tt>true</tt> if the quit is successful, or <tt>false</tt> otherwise
	 */
	public boolean quit() {
		if (closeAllFrames())
			System.exit(0);
